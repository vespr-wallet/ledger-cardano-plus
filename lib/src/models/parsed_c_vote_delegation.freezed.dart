...
$ParsedCVoteDelegationCopyWith<ParsedCVoteDelegation> get copyWith => _$ParsedCVoteDelegationCopyWithImpl<ParsedCVoteDelegation>(this as ParsedCVoteDelegation, _$identity);
...
abstract mixin class $ParsedCVoteDelegationCopyWith<$Res>  {
  factory $ParsedCVoteDelegationCopyWith(ParsedCVoteDelegation value, $Res Function(ParsedCVoteDelegation) _then) = _$ParsedCVoteDelegationCopyWithImpl;
@useResult
$Res call({
 int weight
});
...
@pragma('vm:prefer-inline')
$PathDelegationCopyWith<PathDelegation> get copyWith => _$PathDelegationCopyWithImpl<PathDelegation>(this, _$identity);
...
/// @nodoc
abstract mixin class $PathDelegationCopyWith<$Res> implements $ParsedCVoteDelegationCopyWith<$Res> {
  factory $PathDelegationCopyWith(PathDelegation value, $Res Function(PathDelegation) _then) = _$PathDelegationCopyWithImpl;
@override @useResult
$Res call({
...
/// Create a copy of ParsedCVoteDelegation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? voteKeyPath = null,Object? weight = null,}) {
  return _then(PathDelegation(
voteKeyPath: null == voteKeyPath ? _self.voteKeyPath : voteKeyPath // ignore: cast_nullable_to_non_nullable
as LedgerSigningPath,weight: null == weight ? _self.weight : weight // ignore: cast_nullable_to_non_nullable
as int,
  ));
}
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$KeyDelegationCopyWith<KeyDelegation> get copyWith => _$KeyDelegationCopyWithImpl<KeyDelegation>(this, _$identity);
...
/// @nodoc
abstract mixin class $KeyDelegationCopyWith<$Res> implements $ParsedCVoteDelegationCopyWith<$Res> {
  factory $KeyDelegationCopyWith(KeyDelegation value, $Res Function(KeyDelegation) _then) = _$KeyDelegationCopyWithImpl;
@override @useResult
$Res call({
...
/// Create a copy of ParsedCVoteDelegation
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? voteKey = null,Object? weight = null,}) {
  return _then(KeyDelegation(
voteKey: null == voteKey ? _self.voteKey : voteKey // ignore: cast_nullable_to_non_nullable
