...
mixin _$ParsedTransaction {
  ...
  $ParsedTransactionCopyWith<ParsedTransaction> get copyWith =>
      _$ParsedTransactionCopyWithImpl<ParsedTransaction>(
          this as ParsedTransaction, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.collateralInputs, collateralInputs) &&
            const DeepCollectionEquality()
                .equals(other.requiredSigners, requiredSigners) &&
            ...
            const DeepCollectionEquality()
                .equals(other.referenceInputs, referenceInputs) &&
            const DeepCollectionEquality()
                .equals(other.votingProcedures, votingProcedures) &&
  ...
  int get hashCode => Object.hashAll([
        ...
        scriptDataHashHex,
        const DeepCollectionEquality().hash(collateralInputs),
        const DeepCollectionEquality().hash(requiredSigners),
        includeNetworkId,
        collateralOutput,
        totalCollateral,
        const DeepCollectionEquality().hash(referenceInputs),
        const DeepCollectionEquality().hash(votingProcedures),
        treasury,
        donation
      ]);
...
abstract mixin class $ParsedTransactionCopyWith<$Res> {
  factory $ParsedTransactionCopyWith(
          ParsedTransaction value, $Res Function(ParsedTransaction) _then) =
      _$ParsedTransactionCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
abstract mixin class _$ParsedTransactionCopyWith<$Res>
    implements $ParsedTransactionCopyWith<$Res> {
  factory _$ParsedTransactionCopyWith(
          _ParsedTransaction value, $Res Function(_ParsedTransaction) _then) =
    ...
    return _then(_ParsedTransaction(
      ...
      scriptDataHashHex: freezed == scriptDataHashHex
          ...
          : scriptDataHashHex // ignore: cast_nullable_to_non_nullable
              as ScriptDataHash?,
      collateralInputs: freezed == collateralInputs
          ? _self._collateralInputs
          : collateralInputs // ignore: cast_nullable_to_non_nullable
              as List<ParsedInput>?,
      requiredSigners: freezed == requiredSigners
          ? _self._requiredSigners
          : requiredSigners // ignore: cast_nullable_to_non_nullable
              as List<ParsedRequiredSigner>?,
      includeNetworkId: freezed == includeNetworkId
          ? _self.includeNetworkId
      ...
      totalCollateral: freezed == totalCollateral
          ...
          : totalCollateral // ignore: cast_nullable_to_non_nullable
              as BigInt?,
      referenceInputs: freezed == referenceInputs
          ? _self._referenceInputs
          : referenceInputs // ignore: cast_nullable_to_non_nullable
              as List<ParsedInput>?,
      votingProcedures: freezed == votingProcedures
          ? _self._votingProcedures
          : votingProcedures // ignore: cast_nullable_to_non_nullable
              as List<ParsedVoterVotes>?,
      treasury: freezed == treasury
          ? _self.treasury
