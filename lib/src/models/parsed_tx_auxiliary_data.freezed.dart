...
class _$ArbitraryHashImpl extends ArbitraryHash {
  const _$ArbitraryHashImpl({required this.hashHex}) : super._();
...
abstract class ArbitraryHash extends ParsedTxAuxiliaryData {
  const factory ArbitraryHash({required final String hashHex}) =
      _$ArbitraryHashImpl;
...
class _$CIP36RegistrationImpl extends CIP36Registration {
  const _$CIP36RegistrationImpl({required this.params}) : super._();
