...
mixin _$ParsedVotingProcedure {
  ...
  $ParsedVotingProcedureCopyWith<ParsedVotingProcedure> get copyWith =>
      _$ParsedVotingProcedureCopyWithImpl<ParsedVotingProcedure>(
          this as ParsedVotingProcedure, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedVotingProcedure &&
...
abstract mixin class $ParsedVotingProcedureCopyWith<$Res> {
  factory $ParsedVotingProcedureCopyWith(ParsedVotingProcedure value,
          $Res Function(ParsedVotingProcedure) _then) =
      _$ParsedVotingProcedureCopyWithImpl;
  @useResult
...
class _ParsedVotingProcedure extends ParsedVotingProcedure {
  _ParsedVotingProcedure({required this.vote, required this.anchor})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParsedVotingProcedureCopyWith<_ParsedVotingProcedure> get copyWith =>
      __$ParsedVotingProcedureCopyWithImpl<_ParsedVotingProcedure>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ParsedVotingProcedure &&
            (identical(other.vote, vote) || other.vote == vote) &&
            (identical(other.anchor, anchor) || other.anchor == anchor));
  }
...
/// @nodoc
abstract mixin class _$ParsedVotingProcedureCopyWith<$Res>
    implements $ParsedVotingProcedureCopyWith<$Res> {
  factory _$ParsedVotingProcedureCopyWith(_ParsedVotingProcedure value,
          $Res Function(_ParsedVotingProcedure) _then) =
      __$ParsedVotingProcedureCopyWithImpl;
  @override
  @useResult
  $Res call({VoteOption vote, ParsedAnchor? anchor});
