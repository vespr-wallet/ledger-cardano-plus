...
mixin _$LedgerDevice {
 ...
 String get id; String get name; LedgerConnectionType get connectionType; int get rssi; LedgerDeviceType get deviceInfo;
/// Create a copy of LedgerDevice
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$LedgerDeviceCopyWith<LedgerDevice> get copyWith => _$LedgerDeviceCopyWithImpl<LedgerDevice>(this as LedgerDevice, _$identity);
...
abstract mixin class $LedgerDeviceCopyWith<$Res>  {
  factory $LedgerDeviceCopyWith(LedgerDevice value, $Res Function(LedgerDevice) _then) = _$LedgerDeviceCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$LedgerDeviceCopyWithImpl<$Res>
...
as LedgerConnectionType,rssi: null == rssi ? _self.rssi : rssi // ignore: cast_nullable_to_non_nullable
as int,deviceInfo: null == deviceInfo ? _self.deviceInfo : deviceInfo // ignore: cast_nullable_to_non_nullable
as LedgerDeviceType,
  ));
}
...
class _LedgerDevice extends LedgerDevice {
  const _LedgerDevice({required this.id, required this.name, required this.connectionType, required this.rssi, required this.deviceInfo}): super._();
...
@pragma('vm:prefer-inline')
_$LedgerDeviceCopyWith<_LedgerDevice> get copyWith => __$LedgerDeviceCopyWithImpl<_LedgerDevice>(this, _$identity);
...
/// @nodoc
abstract mixin class _$LedgerDeviceCopyWith<$Res> implements $LedgerDeviceCopyWith<$Res> {
  factory _$LedgerDeviceCopyWith(_LedgerDevice value, $Res Function(_LedgerDevice) _then) = __$LedgerDeviceCopyWithImpl;
@override @useResult
$Res call({
 String id, String name, LedgerConnectionType connectionType, int rssi, LedgerDeviceType deviceInfo
});
...
/// Create a copy of LedgerDevice
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? connectionType = null,Object? rssi = null,Object? deviceInfo = null,}) {
