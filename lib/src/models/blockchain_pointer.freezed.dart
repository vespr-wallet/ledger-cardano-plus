...
abstract class $BlockchainPointerCopyWith<$Res> {
  factory $BlockchainPointerCopyWith(
          BlockchainPointer value, $Res Function(BlockchainPointer) then) =
      _$BlockchainPointerCopyWithImpl<$Res, BlockchainPointer>;
  @useResult
  $Res call({int blockIndex, int txIndex, int certificateIndex});
}

/// @nodoc
class _$BlockchainPointerCopyWithImpl<$Res, $Val extends BlockchainPointer>
...
/// @nodoc
abstract class _$$BlockchainPointerImplCopyWith<$Res>
    implements $BlockchainPointerCopyWith<$Res> {
  factory _$$BlockchainPointerImplCopyWith(_$BlockchainPointerImpl value,
          $Res Function(_$BlockchainPointerImpl) then) =
      __$$BlockchainPointerImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({int blockIndex, int txIndex, int certificateIndex});
}
...
/// @nodoc
class __$$BlockchainPointerImplCopyWithImpl<$Res>
    extends _$BlockchainPointerCopyWithImpl<$Res, _$BlockchainPointerImpl>
    implements _$$BlockchainPointerImplCopyWith<$Res> {
  __$$BlockchainPointerImplCopyWithImpl(_$BlockchainPointerImpl _value,
      $Res Function(_$BlockchainPointerImpl) _then)
      : super(_value, _then);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$BlockchainPointerImpl &&
