...
mixin _$ParsedSigningRequest {
  ...
  $ParsedSigningRequestCopyWith<ParsedSigningRequest> get copyWith =>
      _$ParsedSigningRequestCopyWithImpl<ParsedSigningRequest>(
          this as ParsedSigningRequest, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedSigningRequest &&
            (identical(other.tx, tx) || other.tx == tx) &&
            (identical(other.signingMode, signingMode) ||
                other.signingMode == signingMode) &&
            const DeepCollectionEquality()
                .equals(other.additionalWitnessPaths, additionalWitnessPaths) &&
            (identical(other.options, options) || other.options == options));
  }

  @override
  int get hashCode => Object.hash(runtimeType, tx, signingMode,
      const DeepCollectionEquality().hash(additionalWitnessPaths), options);
...
abstract mixin class $ParsedSigningRequestCopyWith<$Res> {
  factory $ParsedSigningRequestCopyWith(ParsedSigningRequest value,
          $Res Function(ParsedSigningRequest) _then) =
      _$ParsedSigningRequestCopyWithImpl;
  @useResult
  $Res call(
...
class _ParsedSigningRequest extends ParsedSigningRequest {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParsedSigningRequestCopyWith<_ParsedSigningRequest> get copyWith =>
      __$ParsedSigningRequestCopyWithImpl<_ParsedSigningRequest>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ParsedSigningRequest &&
            (identical(other.tx, tx) || other.tx == tx) &&
            (identical(other.signingMode, signingMode) ||
                other.signingMode == signingMode) &&
...
/// @nodoc
abstract mixin class _$ParsedSigningRequestCopyWith<$Res>
    implements $ParsedSigningRequestCopyWith<$Res> {
  factory _$ParsedSigningRequestCopyWith(_ParsedSigningRequest value,
          $Res Function(_ParsedSigningRequest) _then) =
      __$ParsedSigningRequestCopyWithImpl;
  @override
  @useResult
  $Res call(
      {ParsedTransaction tx,
