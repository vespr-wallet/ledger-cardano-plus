  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedPoolRelay &&
            (identical(other.relayType, relayType) ||
...
class $ParsedPoolRelayCopyWith<$Res> {
  $ParsedPoolRelayCopyWith(
      ParsedPoolRelay _, $Res Function(ParsedPoolRelay) __);
}
...
class SingleHostIpAddr extends ParsedPoolRelay {
  ...
  $SingleHostIpAddrCopyWith<SingleHostIpAddr> get copyWith =>
      _$SingleHostIpAddrCopyWithImpl<SingleHostIpAddr>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SingleHostIpAddr &&
...
/// @nodoc
abstract mixin class $SingleHostIpAddrCopyWith<$Res>
    implements $ParsedPoolRelayCopyWith<$Res> {
  factory $SingleHostIpAddrCopyWith(
          SingleHostIpAddr value, $Res Function(SingleHostIpAddr) _then) =
      _$SingleHostIpAddrCopyWithImpl;
  @useResult
...
class SingleHostName extends ParsedPoolRelay {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SingleHostNameCopyWith<SingleHostName> get copyWith =>
      _$SingleHostNameCopyWithImpl<SingleHostName>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SingleHostName &&
            (identical(other.port, port) || other.port == port) &&
...
/// @nodoc
abstract mixin class $SingleHostNameCopyWith<$Res>
    implements $ParsedPoolRelayCopyWith<$Res> {
  factory $SingleHostNameCopyWith(
          SingleHostName value, $Res Function(SingleHostName) _then) =
      _$SingleHostNameCopyWithImpl;
  @useResult
...
class MultiHost extends ParsedPoolRelay {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $MultiHostCopyWith<MultiHost> get copyWith =>
      _$MultiHostCopyWithImpl<MultiHost>(this, _$identity);
...
/// @nodoc
abstract mixin class $MultiHostCopyWith<$Res>
    implements $ParsedPoolRelayCopyWith<$Res> {
  factory $MultiHostCopyWith(MultiHost value, $Res Function(MultiHost) _then) =
      _$MultiHostCopyWithImpl;
  @useResult
  $Res call({String dnsName});
}

/// @nodoc
class _$MultiHostCopyWithImpl<$Res> implements $MultiHostCopyWith<$Res> {
