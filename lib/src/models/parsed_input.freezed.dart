...
mixin _$ParsedInput {
  ...
  $ParsedInputCopyWith<ParsedInput> get copyWith =>
      _$ParsedInputCopyWithImpl<ParsedInput>(this as ParsedInput, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedInput &&
...
abstract mixin class $ParsedInputCopyWith<$Res> {
  factory $ParsedInputCopyWith(
          ParsedInput value, $Res Function(ParsedInput) _then) =
      _$ParsedInputCopyWithImpl;
  @useResult
...
/// @nodoc
class _$ParsedInputCopyWithImpl<$Res> implements $ParsedInputCopyWith<$Res> {
...
class _ParsedInput extends ParsedInput {
  _ParsedInput(
      {required this.txHashHex, required this.outputIndex, required this.path})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParsedInputCopyWith<_ParsedInput> get copyWith =>
      __$ParsedInputCopyWithImpl<_ParsedInput>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ParsedInput &&
            (identical(other.txHashHex, txHashHex) ||
                other.txHashHex == txHashHex) &&
            (identical(other.outputIndex, outputIndex) ||
                other.outputIndex == outputIndex) &&
...
/// @nodoc
abstract mixin class _$ParsedInputCopyWith<$Res>
    implements $ParsedInputCopyWith<$Res> {
  factory _$ParsedInputCopyWith(
          _ParsedInput value, $Res Function(_ParsedInput) _then) =
      __$ParsedInputCopyWithImpl;
  @override
  @useResult
  $Res call({String txHashHex, int outputIndex, LedgerSigningPath? path});
...
/// @nodoc
class __$ParsedInputCopyWithImpl<$Res> implements _$ParsedInputCopyWith<$Res> {
