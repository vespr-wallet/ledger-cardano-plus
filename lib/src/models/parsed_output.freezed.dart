...
mixin _$ParsedOutput {
  ...
  $ParsedOutputCopyWith<ParsedOutput> get copyWith =>
      _$ParsedOutputCopyWithImpl<ParsedOutput>(
          this as ParsedOutput, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.outputDatum, outputDatum) ||
                other.outputDatum == outputDatum) &&
            (identical(other.referenceScriptHash, referenceScriptHash) ||
                other.referenceScriptHash == referenceScriptHash) &&
            (identical(other.destination, destination) ||
                other.destination == destination) &&
            (identical(other.amount, amount) || other.amount == amount) &&
            const DeepCollectionEquality()
                .equals(other.tokenBundle, tokenBundle));
  }
  ...
  int get hashCode => Object.hash(
      ...
      destination,
      amount,
      const DeepCollectionEquality().hash(tokenBundle));
...
abstract mixin class $ParsedOutputCopyWith<$Res> {
  factory $ParsedOutputCopyWith(
          ParsedOutput value, $Res Function(ParsedOutput) _then) =
      _$ParsedOutputCopyWithImpl;
  @useResult
  $Res call(
...
/// @nodoc
class _$ParsedOutputCopyWithImpl<$Res> implements $ParsedOutputCopyWith<$Res> {
...
class ParsedOutputAlonzo extends ParsedOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ParsedOutputAlonzoCopyWith<ParsedOutputAlonzo> get copyWith =>
      _$ParsedOutputAlonzoCopyWithImpl<ParsedOutputAlonzo>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedOutputAlonzo &&
            (identical(other.destination, destination) ||
                other.destination == destination) &&
            (identical(other.amount, amount) || other.amount == amount) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class $ParsedOutputAlonzoCopyWith<$Res>
    implements $ParsedOutputCopyWith<$Res> {
  factory $ParsedOutputAlonzoCopyWith(
          ParsedOutputAlonzo value, $Res Function(ParsedOutputAlonzo) _then) =
      _$ParsedOutputAlonzoCopyWithImpl;
  @override
  @useResult
  $Res call(
      {ParsedOutputDestination destination,
...
class ParsedOutputBabbage extends ParsedOutput {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $ParsedOutputBabbageCopyWith<ParsedOutputBabbage> get copyWith =>
      _$ParsedOutputBabbageCopyWithImpl<ParsedOutputBabbage>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedOutputBabbage &&
            (identical(other.destination, destination) ||
                other.destination == destination) &&
            (identical(other.amount, amount) || other.amount == amount) &&
            const DeepCollectionEquality()
...
/// @nodoc
abstract mixin class $ParsedOutputBabbageCopyWith<$Res>
    implements $ParsedOutputCopyWith<$Res> {
  factory $ParsedOutputBabbageCopyWith(
          ParsedOutputBabbage value, $Res Function(ParsedOutputBabbage) _then) =
      _$ParsedOutputBabbageCopyWithImpl;
  @override
  @useResult
  $Res call(
      {ParsedOutputDestination destination,
