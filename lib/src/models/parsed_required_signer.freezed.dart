  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedRequiredSigner &&
            (identical(other.requiredSignerValue, requiredSignerValue) ||
                other.requiredSignerValue == requiredSignerValue));
  }
...
class $ParsedRequiredSignerCopyWith<$Res> {
  $ParsedRequiredSignerCopyWith(
      ParsedRequiredSigner _, $Res Function(ParsedRequiredSigner) __);
}
...
class RequiredSignerHash extends ParsedRequiredSigner {
  ...
  $RequiredSignerHashCopyWith<RequiredSignerHash> get copyWith =>
      _$RequiredSignerHashCopyWithImpl<RequiredSignerHash>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RequiredSignerHash &&
...
/// @nodoc
abstract mixin class $RequiredSignerHashCopyWith<$Res>
    implements $ParsedRequiredSignerCopyWith<$Res> {
  factory $RequiredSignerHashCopyWith(
          RequiredSignerHash value, $Res Function(RequiredSignerHash) _then) =
      _$RequiredSignerHashCopyWithImpl;
  @useResult
...
class RequiredSignerPath extends ParsedRequiredSigner {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $RequiredSignerPathCopyWith<RequiredSignerPath> get copyWith =>
      _$RequiredSignerPathCopyWithImpl<RequiredSignerPath>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is RequiredSignerPath &&
...
/// @nodoc
abstract mixin class $RequiredSignerPathCopyWith<$Res>
    implements $ParsedRequiredSignerCopyWith<$Res> {
  factory $RequiredSignerPathCopyWith(
          RequiredSignerPath value, $Res Function(RequiredSignerPath) _then) =
      _$RequiredSignerPathCopyWithImpl;
  @useResult
