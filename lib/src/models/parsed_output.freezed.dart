...
mixin _$ParsedOutput {
 ...
 ParsedOutputDestination get destination => throw _privateConstructorUsedError; BigInt get amount => throw _privateConstructorUsedError; List<ParsedAssetGroup> get tokenBundle => throw _privateConstructorUsedError;
...
abstract class $ParsedOutputCopyWith<$Res>  {
  factory $ParsedOutputCopyWith(ParsedOutput value, $Res Function(ParsedOutput) then) = _$ParsedOutputCopyWithImpl<$Res, ParsedOutput>;
@useResult
$Res call({
...
/// @nodoc
class _$ParsedOutputCopyWithImpl<$Res,$Val extends ParsedOutput> implements $ParsedOutputCopyWith<$Res> {
...
as ParsedOutputDestination,amount: null == amount ? _value.amount : amount // ignore: cast_nullable_to_non_nullable
as BigInt,tokenBundle: null == tokenBundle ? _value.tokenBundle : tokenBundle // ignore: cast_nullable_to_non_nullable
...
/// @nodoc
abstract class _$$ParsedOutputAlonzoImplCopyWith<$Res> implements $ParsedOutputCopyWith<$Res> {
  factory _$$ParsedOutputAlonzoImplCopyWith(_$ParsedOutputAlonzoImpl value, $Res Function(_$ParsedOutputAlonzoImpl) then) = __$$ParsedOutputAlonzoImplCopyWithImpl<$Res>;
@override @useResult
$Res call({
...
/// @nodoc
class __$$ParsedOutputAlonzoImplCopyWithImpl<$Res> extends _$ParsedOutputCopyWithImpl<$Res, _$ParsedOutputAlonzoImpl> implements _$$ParsedOutputAlonzoImplCopyWith<$Res> {
  __$$ParsedOutputAlonzoImplCopyWithImpl(_$ParsedOutputAlonzoImpl _value, $Res Function(_$ParsedOutputAlonzoImpl) _then)
      : super(_value, _then);
...
destination: null == destination ? _value.destination : destination // ignore: cast_nullable_to_non_nullable
as ParsedOutputDestination,amount: null == amount ? _value.amount : amount // ignore: cast_nullable_to_non_nullable
as BigInt,tokenBundle: null == tokenBundle ? _value._tokenBundle : tokenBundle // ignore: cast_nullable_to_non_nullable
as List<ParsedAssetGroup>,datumHashHex: freezed == datumHashHex ? _value.datumHashHex : datumHashHex // ignore: cast_nullable_to_non_nullable
as ParsedDatumHash?,
  ));
}
...
class _$ParsedOutputAlonzoImpl extends ParsedOutputAlonzo  {
   _$ParsedOutputAlonzoImpl({required this.destination, required this.amount, final  List<ParsedAssetGroup> tokenBundle = const [], this.datumHashHex}): _tokenBundle = tokenBundle,super._();
...
@override final  ParsedDatumHash? datumHashHex;
...
abstract class ParsedOutputAlonzo extends ParsedOutput {
   factory ParsedOutputAlonzo({required final  ParsedOutputDestination destination, required final  BigInt amount, final  List<ParsedAssetGroup> tokenBundle, final  ParsedDatumHash? datumHashHex}) = _$ParsedOutputAlonzoImpl;
...
/// @nodoc
abstract class _$$ParsedOutputBabbageImplCopyWith<$Res> implements $ParsedOutputCopyWith<$Res> {
  factory _$$ParsedOutputBabbageImplCopyWith(_$ParsedOutputBabbageImpl value, $Res Function(_$ParsedOutputBabbageImpl) then) = __$$ParsedOutputBabbageImplCopyWithImpl<$Res>;
@override @useResult
$Res call({
...
/// @nodoc
class __$$ParsedOutputBabbageImplCopyWithImpl<$Res> extends _$ParsedOutputCopyWithImpl<$Res, _$ParsedOutputBabbageImpl> implements _$$ParsedOutputBabbageImplCopyWith<$Res> {
  __$$ParsedOutputBabbageImplCopyWithImpl(_$ParsedOutputBabbageImpl _value, $Res Function(_$ParsedOutputBabbageImpl) _then)
      : super(_value, _then);
...
as ParsedOutputDestination,amount: null == amount ? _value.amount : amount // ignore: cast_nullable_to_non_nullable
as BigInt,tokenBundle: null == tokenBundle ? _value._tokenBundle : tokenBundle // ignore: cast_nullable_to_non_nullable
as List<ParsedAssetGroup>,datum: freezed == datum ? _value.datum : datum // ignore: cast_nullable_to_non_nullable
as ParsedDatum?,referenceScriptHex: freezed == referenceScriptHex ? _value.referenceScriptHex : referenceScriptHex // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
class _$ParsedOutputBabbageImpl extends ParsedOutputBabbage  {
   _$ParsedOutputBabbageImpl({required this.destination, required this.amount, final  List<ParsedAssetGroup> tokenBundle = const [], this.datum, this.referenceScriptHex}): _tokenBundle = tokenBundle,super._();
...
@override final  ParsedDatum? datum;
@override final  String? referenceScriptHex;
...
abstract class ParsedOutputBabbage extends ParsedOutput {
   factory ParsedOutputBabbage({required final  ParsedOutputDestination destination, required final  BigInt amount, final  List<ParsedAssetGroup> tokenBundle, final  ParsedDatum? datum, final  String? referenceScriptHex}) = _$ParsedOutputBabbageImpl;
