...
mixin _$SpendingParams {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is SpendingParams);
  }
...
class SpendingParamsPath extends SpendingParams {
  ...
  $SpendingParamsPathCopyWith<SpendingParamsPath> get copyWith =>
      _$SpendingParamsPathCopyWithImpl<SpendingParamsPath>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SpendingParamsPath &&
...
/// @nodoc
abstract mixin class $SpendingParamsPathCopyWith<$Res>
    implements $SpendingParamsCopyWith<$Res> {
  factory $SpendingParamsPathCopyWith(
          SpendingParamsPath value, $Res Function(SpendingParamsPath) _then) =
      _$SpendingParamsPathCopyWithImpl;
  @useResult
...
class SpendingParamsScriptHash extends SpendingParams {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $SpendingParamsScriptHashCopyWith<SpendingParamsScriptHash> get copyWith =>
      _$SpendingParamsScriptHashCopyWithImpl<SpendingParamsScriptHash>(
          this, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is SpendingParamsScriptHash &&
...
/// @nodoc
abstract mixin class $SpendingParamsScriptHashCopyWith<$Res>
    implements $SpendingParamsCopyWith<$Res> {
  factory $SpendingParamsScriptHashCopyWith(SpendingParamsScriptHash value,
          $Res Function(SpendingParamsScriptHash) _then) =
      _$SpendingParamsScriptHashCopyWithImpl;
  @useResult
