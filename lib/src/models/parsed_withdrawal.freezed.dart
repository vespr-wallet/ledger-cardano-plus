...
mixin _$ParsedWithdrawal {
  ...
  $ParsedWithdrawalCopyWith<ParsedWithdrawal> get copyWith =>
      _$ParsedWithdrawalCopyWithImpl<ParsedWithdrawal>(
          this as ParsedWithdrawal, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedWithdrawal &&
...
abstract mixin class $ParsedWithdrawalCopyWith<$Res> {
  factory $ParsedWithdrawalCopyWith(
          ParsedWithdrawal value, $Res Function(ParsedWithdrawal) _then) =
      _$ParsedWithdrawalCopyWithImpl;
  @useResult
...
class _ParsedWithdrawal extends ParsedWithdrawal {
  _ParsedWithdrawal({required this.amount, required this.stakeCredential})
      : super._();
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParsedWithdrawalCopyWith<_ParsedWithdrawal> get copyWith =>
      __$ParsedWithdrawalCopyWithImpl<_ParsedWithdrawal>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ParsedWithdrawal &&
            (identical(other.amount, amount) || other.amount == amount) &&
            (identical(other.stakeCredential, stakeCredential) ||
                other.stakeCredential == stakeCredential));
  }
...
/// @nodoc
abstract mixin class _$ParsedWithdrawalCopyWith<$Res>
    implements $ParsedWithdrawalCopyWith<$Res> {
  factory _$ParsedWithdrawalCopyWith(
          _ParsedWithdrawal value, $Res Function(_ParsedWithdrawal) _then) =
      __$ParsedWithdrawalCopyWithImpl;
  @override
  @useResult
  $Res call({BigInt amount, ParsedCredential stakeCredential});
