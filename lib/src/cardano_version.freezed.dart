...
mixin _$CardanoVersion {
  ...
  VersionCompatibility get compatibility;
  bool get testMode;
  ...
  $CardanoVersionCopyWith<CardanoVersion> get copyWith =>
      _$CardanoVersionCopyWithImpl<CardanoVersion>(
          this as CardanoVersion, _$identity);
...
abstract mixin class $CardanoVersionCopyWith<$Res> {
  factory $CardanoVersionCopyWith(
          CardanoVersion value, $Res Function(CardanoVersion) _then) =
      _$CardanoVersionCopyWithImpl;
  @useResult
  $Res call(
      {bool testMode,
      int versionMajor,
...
class _CardanoVersion extends CardanoVersion {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CardanoVersionCopyWith<_CardanoVersion> get copyWith =>
      __$CardanoVersionCopyWithImpl<_CardanoVersion>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _CardanoVersion &&
            (identical(other.testMode, testMode) ||
                other.testMode == testMode) &&
            (identical(other.versionMajor, versionMajor) ||
                other.versionMajor == versionMajor) &&
  ...
  @override
  int get hashCode => Object.hash(runtimeType, testMode, versionMajor,
      versionMinor, versionPatch, locked, flags);
...
/// @nodoc
abstract mixin class _$CardanoVersionCopyWith<$Res>
    implements $CardanoVersionCopyWith<$Res> {
  factory _$CardanoVersionCopyWith(
          _CardanoVersion value, $Res Function(_CardanoVersion) _then) =
      __$CardanoVersionCopyWithImpl;
  @override
  @useResult
  $Res call(
      {bool testMode,
