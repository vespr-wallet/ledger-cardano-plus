...
class DatumHash extends Datum {
  ...
  $DatumHashCopyWith<DatumHash> get copyWith =>
      _$DatumHashCopyWithImpl<DatumHash>(this, _$identity);
...
abstract mixin class $DatumHashCopyWith<$Res> implements $DatumCopyWith<$Res> {
  factory $DatumHashCopyWith(DatumHash value, $Res Function(DatumHash) _then) =
      _$DatumHashCopyWithImpl;
  @useResult
  $Res call({String datumHashHex});
}

/// @nodoc
class _$DatumHashCopyWithImpl<$Res> implements $DatumHashCopyWith<$Res> {
...
class DatumInline extends Datum {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $DatumInlineCopyWith<DatumInline> get copyWith =>
      _$DatumInlineCopyWithImpl<DatumInline>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is DatumInline &&
...
/// @nodoc
abstract mixin class $DatumInlineCopyWith<$Res>
    implements $DatumCopyWith<$Res> {
  factory $DatumInlineCopyWith(
          DatumInline value, $Res Function(DatumInline) _then) =
      _$DatumInlineCopyWithImpl;
  @useResult
  $Res call({String datumHex});
}

/// @nodoc
class _$DatumInlineCopyWithImpl<$Res> implements $DatumInlineCopyWith<$Res> {
