...
mixin _$ParsedVotingProcedure {
 ...
 VoteOption get vote => throw _privateConstructorUsedError; ParsedAnchor? get anchor => throw _privateConstructorUsedError;
...
abstract class $ParsedVotingProcedureCopyWith<$Res>  {
  factory $ParsedVotingProcedureCopyWith(ParsedVotingProcedure value, $Res Function(ParsedVotingProcedure) then) = _$ParsedVotingProcedureCopyWithImpl<$Res, ParsedVotingProcedure>;
@useResult
$Res call({
...
/// @nodoc
class _$ParsedVotingProcedureCopyWithImpl<$Res,$Val extends ParsedVotingProcedure> implements $ParsedVotingProcedureCopyWith<$Res> {
...
as VoteOption,anchor: freezed == anchor ? _value.anchor : anchor // ignore: cast_nullable_to_non_nullable
as ParsedAnchor?,
  )as $Val);
}
@override
...
/// @nodoc
abstract class _$$ParsedVotingProcedureImplCopyWith<$Res> implements $ParsedVotingProcedureCopyWith<$Res> {
  factory _$$ParsedVotingProcedureImplCopyWith(_$ParsedVotingProcedureImpl value, $Res Function(_$ParsedVotingProcedureImpl) then) = __$$ParsedVotingProcedureImplCopyWithImpl<$Res>;
@override @useResult
$Res call({
 VoteOption vote, ParsedAnchor? anchor
});
...
/// @nodoc
class __$$ParsedVotingProcedureImplCopyWithImpl<$Res> extends _$ParsedVotingProcedureCopyWithImpl<$Res, _$ParsedVotingProcedureImpl> implements _$$ParsedVotingProcedureImplCopyWith<$Res> {
  __$$ParsedVotingProcedureImplCopyWithImpl(_$ParsedVotingProcedureImpl _value, $Res Function(_$ParsedVotingProcedureImpl) _then)
      : super(_value, _then);
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _$ParsedVotingProcedureImpl&&(identical(other.vote, vote) || other.vote == vote)&&(identical(other.anchor, anchor) || other.anchor == anchor));
}
