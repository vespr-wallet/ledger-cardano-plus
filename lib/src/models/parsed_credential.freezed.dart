  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedCredential &&
            (identical(other.credentialValue, credentialValue) ||
                other.credentialValue == credentialValue));
  }
...
class $ParsedCredentialCopyWith<$Res> {
  $ParsedCredentialCopyWith(
      ParsedCredential _, $Res Function(ParsedCredential) __);
}
...
class CredentialKeyPath extends ParsedCredential {
  ...
  $CredentialKeyPathCopyWith<CredentialKeyPath> get copyWith =>
      _$CredentialKeyPathCopyWithImpl<CredentialKeyPath>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CredentialKeyPath &&
...
/// @nodoc
abstract mixin class $CredentialKeyPathCopyWith<$Res>
    implements $ParsedCredentialCopyWith<$Res> {
  factory $CredentialKeyPathCopyWith(
          CredentialKeyPath value, $Res Function(CredentialKeyPath) _then) =
      _$CredentialKeyPathCopyWithImpl;
  @useResult
...
class CredentialKeyHash extends ParsedCredential {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CredentialKeyHashCopyWith<CredentialKeyHash> get copyWith =>
      _$CredentialKeyHashCopyWithImpl<CredentialKeyHash>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CredentialKeyHash &&
...
/// @nodoc
abstract mixin class $CredentialKeyHashCopyWith<$Res>
    implements $ParsedCredentialCopyWith<$Res> {
  factory $CredentialKeyHashCopyWith(
          CredentialKeyHash value, $Res Function(CredentialKeyHash) _then) =
      _$CredentialKeyHashCopyWithImpl;
  @useResult
...
class CredentialScriptHash extends ParsedCredential {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $CredentialScriptHashCopyWith<CredentialScriptHash> get copyWith =>
      _$CredentialScriptHashCopyWithImpl<CredentialScriptHash>(
          this, _$identity);
...
/// @nodoc
abstract mixin class $CredentialScriptHashCopyWith<$Res>
    implements $ParsedCredentialCopyWith<$Res> {
  factory $CredentialScriptHashCopyWith(CredentialScriptHash value,
          $Res Function(CredentialScriptHash) _then) =
      _$CredentialScriptHashCopyWithImpl;
  @useResult
