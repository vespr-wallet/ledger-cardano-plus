...
mixin _$CardanoNetwork {
  ...
  int get networkId;
  String get paymentBech32Hrp;
  String get stakeBech32Hrp;

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is CardanoNetwork &&
            (identical(other.networkMagic, networkMagic) ||
                other.networkMagic == networkMagic) &&
            (identical(other.networkId, networkId) ||
                other.networkId == networkId) &&
            (identical(other.paymentBech32Hrp, paymentBech32Hrp) ||
                other.paymentBech32Hrp == paymentBech32Hrp) &&
            (identical(other.stakeBech32Hrp, stakeBech32Hrp) ||
                other.stakeBech32Hrp == stakeBech32Hrp));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, networkMagic, networkId, paymentBech32Hrp, stakeBech32Hrp);
...
class NetworkMainnet extends CardanoNetwork {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is NetworkMainnet);
  }
...
class NetworkLegacyTestnet extends CardanoNetwork {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is NetworkLegacyTestnet);
  }
...
class NetworkPreProd extends CardanoNetwork {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is NetworkPreProd);
  }
...
class NetworkPreview extends CardanoNetwork {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is NetworkPreview);
  }
...
class NetworkConway extends CardanoNetwork {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is NetworkConway);
  }
...
class NetworkCustom extends CardanoNetwork {
  ...
  $NetworkCustomCopyWith<NetworkCustom> get copyWith =>
      _$NetworkCustomCopyWithImpl<NetworkCustom>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is NetworkCustom &&
...
/// @nodoc
abstract mixin class $NetworkCustomCopyWith<$Res>
    implements $CardanoNetworkCopyWith<$Res> {
  factory $NetworkCustomCopyWith(
          NetworkCustom value, $Res Function(NetworkCustom) _then) =
      _$NetworkCustomCopyWithImpl;
  @useResult
  $Res call(
      {int customNetworkId,
