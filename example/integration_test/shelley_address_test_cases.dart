...
List<ShelleyTestCase> shelleyTestCases = [
    ...
    addressParams: ParsedAddressParams.shelley(
      shelleyAddressParams: ShelleyAddressParamsData.basePaymentKeyStakeKey(
        spendingDataSource: SpendingDataSourcePath(
          path: LedgerSigningPath.custom([harden + 1852, harden + 1815, harden + 0, 0, 1]),
        ),
        stakingDataSource: StakingDataSource.keyPath(
          path: LedgerSigningPath.custom([harden + 1852, harden + 1815, harden + 0, 2, 0]),
        ),
      ),
    ),
    expectedResult:
  ...
  ShelleyTestCase(
    ...
    addressParams: ParsedAddressParams.shelley(
      shelleyAddressParams: ShelleyAddressParamsData.basePaymentKeyStakeKey(
        spendingDataSource: SpendingDataSourcePath(
          path: LedgerSigningPath.custom([harden + 1852, harden + 1815, harden + 101, 0, 1]),
        ),
        stakingDataSource: StakingDataSource.keyPath(
          path: LedgerSigningPath.custom([harden + 1852, harden + 1815, harden + 0, 2, 0]),
        ),
  ...
  ShelleyTestCase(
    ...
    addressParams: ParsedAddressParams.shelley(
      shelleyAddressParams: ShelleyAddressParamsData.basePaymentKeyStakeKey(
        spendingDataSource: SpendingDataSourcePath(
          path: LedgerSigningPath.custom([harden + 1852, harden + 1815, harden + 10, 0, 4]),
        ),
        stakingDataSource: StakingDataSource.keyPath(
  ...
  ShelleyTestCase(
    ...
    addressParams: ParsedAddressParams.shelley(
      shelleyAddressParams: ShelleyAddressParamsData.basePaymentKeyStakeKey(
        ...
        stakingDataSource: StakingDataSource.keyPath(
          path: LedgerSigningPath.custom([harden + 1852, harden + 1815, harden + 101, 2, 60]),
        ),
      ),
    ),
    minSupportedVersion: CardanoVersion.fromVersionCode(50002),
    ...
    addressParams: ParsedAddressParams.shelley(
      shelleyAddressParams: ShelleyAddressParamsData.basePaymentKeyStakeKey(
        ...
        stakingDataSource: StakingDataSource.keyHash(
          keyHashHex: '1d227aefa4b773149170885aadba30aab3127cc611ddbc4999def61c',
        ),
      ),
    ),
    expectedResult:
  ...
  ShelleyTestCase(
    ...
    addressParams: ParsedAddressParams.shelley(
      shelleyAddressParams: ShelleyAddressParamsData.basePaymentScriptStakeKey(
        ...
        stakingDataSource: StakingDataSource.keyPath(
          path: LedgerSigningPath.custom([harden + 1852, harden + 1815, harden + 0, 2, 3]),
        ),
      ),
    ),
    minSupportedVersion: CardanoVersion.fromVersionCode(50002),
  ...
  ShelleyTestCase(
    ...
    addressParams: ParsedAddressParams.shelley(
      shelleyAddressParams: ShelleyAddressParamsData.pointerScript(
        spendingDataSource: SpendingDataSource.scriptHash(
          scriptHashHex: '122a946b9ad3d2ddf029d3a828f0468aece76895f15c9efbd69b4277',
        ),
        stakingDataSource: StakingDataSource.blockchainPointer(blockIndex: 1, txIndex: 2, certificateIndex: 3),
      ),
  ...
  ShelleyTestCase(
    ...
    addressParams: ParsedAddressParams.shelley(
      shelleyAddressParams: ShelleyAddressParamsData.rewardKey(
        stakingDataSource: StakingDataSource.keyPath(
          path: LedgerSigningPath.custom([harden + 1852, harden + 1815, harden + 0, 2, 1]),
        ),
      ),
    ),
    minSupportedVersion: CardanoVersion.fromVersionCode(50002),
