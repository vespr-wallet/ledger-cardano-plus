enum InvalidDataReason {
  ...
  outputInvalidReferenceScriptHex(message: 'output invalid reference script hex'),
  outputInconsistentDatum(message: 'output inconsistent datum'),
  outputInconsistentReferenceScript(message: 'output inconsistent reference script'),
  multiassetInvalidPolicyName(message: 'multiasset invalid policy name'),
  multiassetInvalidTokenBundleNotArray(message: 'multiasset invalid token bundle not array'),
  multiassetInvalidTokenBundleTooLarge(message: 'multiasset invalid token bundle too large'),
  multiassetInvalidTokenBundleOrdering(message: 'multiasset invalid token bundle ordering'),
  multiassetInvalidTokenBundleNotUnique(message: 'multiasset invalid token bundle not unique'),
  multiassetInvalidTokenBundleEmpty(message: 'multiasset invalid token bundle empty'),
  ...
  multiassetInvalidAssetGroupNotArray(message: 'multiasset invalid asset group not array'),
  multiassetInvalidAssetGroupTooLarge(message: 'multiasset invalid asset group too large'),
  multiassetInvalidAssetGroupEmpty(message: 'multiasset invalid asset group empty'),
  multiassetInvalidAssetGroupOrdering(message: 'multiasset invalid asset group ordering'),
  multiassetInvalidAssetGroupNotUnique(message: 'multiasset invalid asset group not unique'),
  ...
  addressInvalidSpendingScriptHash(message: 'address invalid spending script hash'),
  addressInvalidBlockchainPointer(message: 'address invalid blockchain pointer'),
  ...
  addressInvalidStakingScriptHash(message: 'address invalid staking script hash'),
  ...
  certificateInvalidStakeCredential(message: 'certificate invalid stake credential'),
  certificateInvalidCommitteeCredential(message: 'certificate invalid committee credential'),
  certificateInvalidDrepCredential(message: 'certificate invalid drep credential'),
  certificateInvalidPoolKeyHash(message: 'certificate invalid pool key hash'),
  certificateSuperfluousPoolKeyHash(message: 'certificate superfluous pool key hash'),
  ...
  poolRegistrationInvalidVrfKeyHash(message: 'pool registration invalid vrf key hash'),
  ...
  poolRegistrationInvalidMarginDenominator(message: 'pool registration invalid margin denominator'),
  ...
  poolRetirementInvalidRetirementEpoch(message: 'pool retirement invalid retirement epoch'),
  ...
  poolRegistrationMetadataInvalidUrl(message: 'pool registration metadata invalid url'),
  poolRegistrationMetadataInvalidHash(message: 'pool registration metadata invalid hash'),
  ...
  withdrawalInvalidStakeCredential(message: 'withdrawal invalid stake credential'),
  ...
  cvoteRegistrationInconsistentWithCip15(message: 'cvote registration inconsistent with cip15'),
  cvoteRegistrationInconsistentWithCip36(message: 'cvote registration inconsistent with cip36'),
  cvoteRegistrationBothKeyAndPath(message: 'cvote registration both key and path'),
  cvoteRegistrationMissingVoteKey(message: 'cvote registration missing vote key'),
  cvoteRegistrationInvalidVoteKey(message: 'cvote registration invalid vote key'),
  cvoteRegistrationInvalidVoteKeyPath(message: 'cvote registration invalid vote key path'),
  cvoteRegistrationInvalidStakingKeyPath(message: 'cvote registration invalid staking key path'),
  cvoteRegistrationInvalidNonce(message: 'cvote registration invalid nonce'),
  cvoteRegistrationInvalidVotingPurpose(message: 'cvote registration invalid voting purpose'),
  cvoteRegistrationDelegationsNotArray(message: 'cvote registration delegations not an array'),
  cvoteDelegationUnknownFormat(message: 'cvote delegation unknown format'),
  cvoteDelegationUnknownDelegationType(message: 'cvote delegation unknown delegation type'),
  ...
  collateralInputContainsReferenceScript(message: 'collateral input contains reference script'),
  ...
  votingProceduresInvalidNumberOfVoters(message: 'voting procedures invalid number of voters'),
  votingProceduresInvalidNumberOfVotes(message: 'voting procedures invalid number of votes'),
  ...
  signModeOrdinaryTotalCollateralNotAllowed(message: 'sign mode ordinary total collateral not allowed'),
  signModeOrdinaryReferenceInputsNotAllowed(message: 'sign mode ordinary reference inputs not allowed'),
  signModeOrdinaryVoterOnlyAsPath(message: 'sign mode ordinary voter only as path'),
  ...
  signModeMultisigTotalCollateralNotAllowed(message: 'sign mode multisig total collateral not allowed'),
  signModeMultisigReferenceInputsNotAllowed(message: 'sign mode multisig reference inputs not allowed'),
  signModeMultisigVoterOnlyAsScript(message: 'sign mode multisig voter only as script'),
  signModePoolOwnerInputWithPathNotAllowed(message: 'sign mode pool owner input with path not allowed'),
  ...
  signModePoolOwnerMintNotAllowed(message: 'sign mode pool owner mint not allowed'),
  signModePoolOwnerScriptDataHashNotAllowed(message: 'sign mode pool owner script data hash not allowed'),
  signModePoolOwnerCollateralInputsNotAllowed(message: 'sign mode pool owner collateral inputs not allowed'),
  signModePoolOwnerCollateralOutputNotAllowed(message: 'sign mode pool owner collateral output not allowed'),
  signModePoolOwnerTotalCollateralNotAllowed(message: 'sign mode pool owner total collateral not allowed'),
  signModePoolOwnerRequiredSignersNotAllowed(message: 'sign mode pool owner required signers not allowed'),
  signModePoolOwnerReferenceInputsNotAllowed(message: 'sign mode pool owner reference inputs not allowed'),
  signModePoolOwnerVotingProceduresNotAllowed(message: 'sign mode pool owner voting procedures not allowed'),
  signModePoolOwnerTreasuryNotAllowed(message: 'sign mode pool owner treasury not allowed'),
  ...
  signModePoolOperatorCollateralInputsNotAllowed(message: 'sign mode pool operator collateral inputs not allowed'),
  signModePoolOperatorCollateralOutputNotAllowed(message: 'sign mode pool operator collateral output not allowed'),
  signModePoolOperatorTotalCollateralNotAllowed(message: 'sign mode pool operator total collateral not allowed'),
  signModePoolOperatorRequiredSignersNotAllowed(message: 'sign mode pool operator required signers not allowed'),
  signModePoolOperatorReferenceInputsNotAllowed(message: 'sign mode pool operator reference inputs not allowed'),
  signModePoolOperatorVotingProceduresNotAllowed(message: 'sign mode pool operator voting procedures not allowed'),
  signModePoolOperatorTreasuryNotAllowed(message: 'sign mode pool operator treasury not allowed'),
  signModePoolOperatorDonationNotAllowed(message: 'sign mode pool operator donation not allowed'),
  signModePlutusDeviceOwnedAddressNotAllowed(message: 'sign mode plutus device owned address not allowed'),
  signModePlutusPoolRegistrationNotAllowed(message: 'sign mode plutus pool registration not allowed'),
  additionalWitnessesNotArray(message: 'additional witnesses not an array'),
  operationalCertificateInvalidKesKey(message: 'operational certificate invalid kes key'),
  operationalCertificateInvalidKesPeriod(message: 'operational certificate invalid kes period'),
  operationalCertificateInvalidIssueCounter(message: 'operational certificate invalid issue counter'),
  operationalCertificateInvalidColdKeyPath(message: 'operational certificate invalid cold key path'),
  cvoteInvalidVotecastData(message: 'cvote invalid votecast data'),
  cvoteInvalidWitness(message: 'cvote invalid witness'),
  deriveNativeScriptHashInvalidData(message: 'derive native script hash invalid data'),
  deriveNativeScriptHashInvalidKeyPath(message: 'derive native script hash invalid key path'),
  deriveNativeScriptHashInvalidKeyHash(message: 'derive native script hash invalid key hash'),
