...
mixin _$ParsedVoterVotes {
  ...
  $ParsedVoterVotesCopyWith<ParsedVoterVotes> get copyWith =>
      _$ParsedVoterVotesCopyWithImpl<ParsedVoterVotes>(
          this as ParsedVoterVotes, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is ParsedVoterVotes &&
  ...
  int get hashCode => Object.hash(
      runtimeType, voter, const DeepCollectionEquality().hash(votes));
...
abstract mixin class $ParsedVoterVotesCopyWith<$Res> {
  factory $ParsedVoterVotesCopyWith(
          ParsedVoterVotes value, $Res Function(ParsedVoterVotes) _then) =
      _$ParsedVoterVotesCopyWithImpl;
  @useResult
...
class _ParsedVoterVotes extends ParsedVoterVotes {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$ParsedVoterVotesCopyWith<_ParsedVoterVotes> get copyWith =>
      __$ParsedVoterVotesCopyWithImpl<_ParsedVoterVotes>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _ParsedVoterVotes &&
            (identical(other.voter, voter) || other.voter == voter) &&
...
/// @nodoc
abstract mixin class _$ParsedVoterVotesCopyWith<$Res>
    implements $ParsedVoterVotesCopyWith<$Res> {
  factory _$ParsedVoterVotesCopyWith(
          _ParsedVoterVotes value, $Res Function(_ParsedVoterVotes) _then) =
      __$ParsedVoterVotesCopyWithImpl;
  @override
  @useResult
  $Res call({ParsedVoter voter, List<ParsedVote> votes});
